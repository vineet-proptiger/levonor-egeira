...
const highlightsData = [
  {
    ...
    desc: 'Situated near ORR Exit 2, Radial Rd. 7 in Kollur, offering seamless connectivity to the Financial District, Gachibowli IT Hub, and Rajiv Gandhi International Airport.',
  },
  {
    icon: Crown,
    title: 'Ultra-Luxury Residences',
    desc: 'Thoughtfully crafted 3 BHK luxury residences with expansive layouts, premium fittings, and architectural brilliance across 35 floors.',
  },
  {
    icon: TreePine,
    title: 'Low-Density Green Living',
    desc: 'Designed with sprawling landscaped gardens, a central courtyard, and abundant open spaces spread across a premium 4.7-acre enclave.',
  },
  {
    icon: Sparkles,
    title: 'World-Class Lifestyle Amenities',
    desc: 'Grand multi-tier clubhouse, resort pool, open-air amphitheatre, fine dining lounge, and dedicated children’s adventure park.',
  },
  {
    icon: TrendingUp,
    title: 'High Growth & Investment Value',
    desc: "Developed by Levonor Projects in Kollur, one of Hyderabad's fastest-growing and most sought-after real estate corridors.",
  },
]
