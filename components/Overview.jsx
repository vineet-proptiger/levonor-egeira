  ...
  >
    ...
    <div className="container mx-auto px-4 sm:px-8 max-w-[1300px] relative z-10">
      ...
      <div className="mb-6 sm:mb-8" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="text-[22px] sm:text-[28px] md:text-[36px] font-semibold leading-tight uppercase tracking-wider text-gray-900" style={{ fontFamily: "var(--font-jost), Montserrat, sans-serif", marginBottom: '6px' }}>Levonor Egeira</h2>
        {/* Decorative Line */}
      ...
      <div className="flex flex-col lg:flex-row items-stretch gap-6 lg:gap-8">
          ...
          >
            <div>
              <p style={{ fontSize: '15.5px', fontFamily: '"Poppins", sans-serif', color: '#E5EDDC', textAlign: 'justify', lineHeight: '1.85', margin: 0 }}>
                ...
                <span style={{ fontWeight: '700', color: '#FFFFFF' }}>e</span>vonor Egeira, situated near ORR Exit 2, Radial Rd. 7, Kollur, Hyderabad, epitomizes luxury living with its thoughtfully designed high-rise residential enclave. Sprawling across 4.7 acres, the development comprises three iconic towers, each boasting 35 floors of architectural brilliance. It is meticulously crafted to provide a harmonious blend of elegance and functionality, catering to those who value a bespoke lifestyle.
                <span className="inline md:hidden">{!isExpanded ? '... ' : ' '}</span>
                <span className={`${isExpanded ? 'inline' : 'hidden'} md:inline`}>
                  The property features expansive living spaces, lush landscaped gardens, and an array of premium amenities that redefine comfort. Residents can enjoy modern conveniences like state-of-the-art fitness centers, swimming pools, dedicated play areas, and serene green zones for relaxation. The strategic location ensures seamless connectivity to major city hubs while maintaining a tranquil environment away from the city's hustle.
                </span>

                <button 
                  onClick={() => setIsExpanded(!isExpanded)}
                  type="button"
                  className="md:hidden text-[#B88A44] hover:text-[#D4A762] font-bold inline-flex items-center gap-1 transition-colors cursor-pointer ml-1 select-none focus:outline-none"
                  style={{ fontSize: '15px' }}
                >
        ...
        <div className="w-full lg:w-[40%] xl:w-5/12 flex flex-col" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
          <div className="image_caption_wrap relative overflow-hidden rounded-2xl shadow-lg border border-[#B88A44]/30 bg-white flex-1 min-h-[380px] sm:min-h-[480px]">
            <Image
              src={overviewImage}
              alt="Levonor Egeira - Tower Elevation"
              fill
