...
const locationLandmarks = [
  { name: 'ORR Exit 2', dist: '5 mins' },
  { name: 'Kollur MMTS Station', dist: '10 mins' },
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <div className="w-full lg:w-[46%] lg:order-2" data-aos="fade-left" data-aos-duration="1000">
            ...
            >
              ...
              {/* <div className="mt-3 pt-2.5 border-t border-[#edf4e3] flex items-center justify-between text-[11px] text-gray-500 font-medium">
                ...
                <span className="text-[#B88A44] font-bold">Kollur</span>
              </div> */}
            </div>
          </div>
          ...
          <div className="w-full lg:flex-1 lg:order-1 flex flex-col justify-center" data-aos="fade-right" data-aos-duration="1000">
            <div style={{
              ...
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.934757851067!2d78.2392478!3d17.462836499999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcbeda7e65f3005%3A0xa6149e94ef3954e5!2sLevonor%20Egeira!5e0!3m2!1sen!2sin!4v1789802427864!5m2!1sen!2sin" 
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  Near ORR Exit 2, Radial Rd. 7, Kollur, Hyderabad
                </span>
              </div>
            </div>
          </div>
